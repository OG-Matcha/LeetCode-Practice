...
For the i_th round, you toggle every i bulb.(i, 2i, 3i, ...)
For the n_th round, you only toggle the last bulb.(n)
...
Later, it will also be toggled in round 6, and round 6 will be the last round when bulb 6 is toggled.
 6
Here, 2,3 and 6 are all factors of (except 1).
